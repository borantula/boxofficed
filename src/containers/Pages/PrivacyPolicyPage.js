...
export default function() {
  return (
    <Paper style={{ textAlign: "left", padding: "5%" }}>
      <h1>Privacy Policy</h1>

      <p>Effective date: October 30, 2018</p>

      <p>
        Box Officed! ("us", "we", or "our") operates the https://boxofficed.com
        website (the "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for Box Officed! is
        managed through{" "}
      ...
      <p>
        ...
        our Terms and Conditions, accessible from https://boxofficed.com
      </p>
      ...
      <p>Box Officed! uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Netherlands and choose to provide information
        to us, please note that we transfer the data, including Personal Data,
        to Netherlands and process it there.
      </p>
      <p>
      ...
      <p>
        Box Officed! will take all steps reasonably necessary to ensure that
      ...
      <p>
        Box Officed! may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Box Officed!</li>
        <li>
      ...
      <ul>
        <li>By email: boxofficed@gmail.com</li>
      </ul>
    </Paper>
  );
}
